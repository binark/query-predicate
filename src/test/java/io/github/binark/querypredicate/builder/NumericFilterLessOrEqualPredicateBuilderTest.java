...
public class NumericFilterLessOrEqualPredicateBuilderTest extends NumericFilterPredicateBuilderTestInit {

    @Test
    void testBuildIsGreaterOrEqualPredicate() {
        TestNumericFilter filter = new TestNumericFilter();
        filter.setIsLessThanOrEqualsTo(new TestNumberObject());
    ...
    void testBuildAndGreaterOrEqualPredicate() {
        ...
        andFilter.setIsLessThanOrEqualsTo(new TestNumberObject());
    ...
    void testBuildOrGreaterOrEqualPredicate() {
        ...
        orFilter.setIsLessThanOrEqualsTo(new TestNumberObject());
