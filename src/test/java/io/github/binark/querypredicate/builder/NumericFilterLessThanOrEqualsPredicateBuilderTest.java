...
class NumericFilterLessThanOrEqualsPredicateBuilderTest {
    ...
    @Test
    void buildNumericPredicate_And_With_Or_Is_LessThan() {
        ...
        assertEquals(ComparisonOperator.LESS_THAN_OR_EQUAL, orComparisonPredicate.getComparisonOperator());
