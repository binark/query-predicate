...
public class ComparableFilterGreaterOrEqualPredicateBuilderTest extends ComparableFilterPredicateBuilderTestInit {

    @Test
    void testBuildIsGreaterOrEqualPredicate() {
        TestComparableFilter filter = new TestComparableFilter();
        filter.setIsGreaterThanOrEqualsTo(new TestComparableObject());
        when(path.getJavaType()).thenReturn(TestComparableObject.class);

        Predicate predicate = predicateBuilder.addGreaterThanOrEqualsToPredicate(basePredicate, filter,
                                                                                 criteriaBuilder, path, FIELD_NAME);
        ...
        assertEquals(ComparisonPredicate.ComparisonOperator.GREATER_THAN_OR_EQUAL,
        ...
        assertEquals(filter.getIsGreaterThanOrEqualsTo(), rightHandOperand.getLiteral());
    }
    ...
    void testBuildAndGreaterOrEqualPredicate() {
        ...
        andFilter.setIsGreaterThanOrEqualsTo(new TestComparableObject());
        ...
        assertEquals(ComparisonPredicate.ComparisonOperator.GREATER_THAN_OR_EQUAL,
                     comparisonPredicate.getComparisonOperator());
        LiteralExpression rightHandOperand = (LiteralExpression) comparisonPredicate.getRightHandOperand();
        assertEquals(andFilter.getIsGreaterThanOrEqualsTo(), rightHandOperand.getLiteral());
    }
    ...
    void testBuildOrGreaterOrEqualPredicate() {
        ...
        orFilter.setIsGreaterThanOrEqualsTo(new TestComparableObject());
        ...
        assertEquals(ComparisonPredicate.ComparisonOperator.GREATER_THAN_OR_EQUAL,
                     comparisonPredicate.getComparisonOperator());
        LiteralExpression rightHandOperand = (LiteralExpression) comparisonPredicate.getRightHandOperand();
        assertEquals(orFilter.getIsGreaterThanOrEqualsTo(), rightHandOperand.getLiteral());
    }
    ...
    void testBuildFullGreaterOrEqualPredicate() {
        ...
        assertEquals(filter.getIsGreaterThanOrEqualsTo(), isGreaterThanRightOperand.getLiteral());
        ...
        assertEquals(andFilter.getIsGreaterThanOrEqualsTo(), andGreaterThanPredicateRightHandOperand.getLiteral());
        assertInstanceOf(ComparisonPredicate.class, expressions.get(1));
        ComparisonPredicate orPredicate = (ComparisonPredicate) expressions.get(1);
        assertEquals(ComparisonPredicate.ComparisonOperator.GREATER_THAN_OR_EQUAL, orPredicate.getComparisonOperator());
