...
class StringFilterEndWithIgnoreCasePredicateBuilderTest extends StringFilterPredicateBuilderTest {
    ...
    void buildEndWithIgnoreCasePredicate() {
        ...
        assertEquals(toUpperCase("%" + filter.getEndWithIgnoreCase()), literalExpression.getLiteral());
        assertInstanceOf(UpperFunction.class, likePredicate.getMatchExpression());
    }

    @Test
    void buildAndEndWithIgnoreCasePredicate() {
        BaseStringFilter andFilter = new BaseStringFilter();
        andFilter.setEndWithIgnoreCase(OTHER_VALUE);
        StringFilter filter = new StringFilter();
        filter.setEndWithIgnoreCase(VALUE);
        ...
        assertEquals(toUpperCase("%" + filter.getEndWithIgnoreCase()), isLiteralExpression.getLiteral());
        ...
        assertEquals(toUpperCase("%" + andFilter.getEndWithIgnoreCase()), andLiteralExpression.getLiteral());
        assertInstanceOf(UpperFunction.class, andPredicate.getMatchExpression());
    }

    @Test
    void buildOrEndWithIgnoreCasePredicate() {
        BaseStringFilter orFilter = new BaseStringFilter();
        orFilter.setEndWithIgnoreCase(OTHER_VALUE);
        StringFilter filter = new StringFilter();
        filter.setEndWithIgnoreCase(VALUE);
        ...
        assertEquals(toUpperCase("%" + orFilter.getEndWithIgnoreCase()), orLiteralExpression.getLiteral());
        assertInstanceOf(UpperFunction.class, orPredicate.getMatchExpression());
    }

    @Test
    void buildFullEndWithIgnoreCasePredicate() {
        BaseStringFilter andFilter = new BaseStringFilter();
        andFilter.setEndWithIgnoreCase("foo");
        BaseStringFilter orFilter = new BaseStringFilter();
        orFilter.setEndWithIgnoreCase(OTHER_VALUE);
        StringFilter filter = new StringFilter();
        filter.setEndWithIgnoreCase(VALUE);
