...
class LocalDateTimeFilterTomorrowPredicateBuilderTest extends LocalDateTimeFilterPredicateBuilderTest {
    ...
    void buildTomorrowPredicate() {
        ...
        assertEquals(LocalDate.now().plusDays(1).atStartOfDay(), lowerBound.getLiteral());
        assertEquals(LocalDate.now().plusDays(1).atTime(LocalTime.MAX), upperBound.getLiteral());
    }
    ...
    void buildAndTomorrowPredicate() {
        ...
        assertEquals(LocalDate.now().plusDays(1).atStartOfDay(), andLowerBound.getLiteral());
        assertEquals(LocalDate.now().plusDays(1).atTime(LocalTime.MAX), andUpperBound.getLiteral());
        ...
        assertEquals(LocalDate.now().plusDays(1).atStartOfDay(), isLowerBound.getLiteral());
        assertEquals(LocalDate.now().plusDays(1).atTime(LocalTime.MAX), isUpperBound.getLiteral());
    }
    ...
    void buildOrTomorrowPredicate() {
        ...
        assertEquals(LocalDate.now().plusDays(1).atStartOfDay(), orLowerBound.getLiteral());
        assertEquals(LocalDate.now().plusDays(1).atTime(LocalTime.MAX), orUpperBound.getLiteral());
