...
class BaseNumericFilterLessThanPredicateBuilderTest {
    ...
    void buildCombinedIsNotNullAndIsLessThanPredicate() {
        ...
        LiteralExpression lessThanLiteralExpression =
                (LiteralExpression) lessThanComparisonPredicate.getRightHandOperand();
