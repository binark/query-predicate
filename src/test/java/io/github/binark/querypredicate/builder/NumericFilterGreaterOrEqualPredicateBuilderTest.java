...
public class NumericFilterGreaterOrEqualPredicateBuilderTest extends NumericFilterPredicateBuilderTestInit {

    @Test
    void testBuildIsGreaterOrEqualPredicate() {
        TestNumericFilter filter = new TestNumericFilter();
        filter.setIsGreaterThanOrEqualsTo(new TestNumberObject());
    ...
    void testBuildAndGreaterOrEqualPredicate() {
        ...
        andFilter.setIsGreaterThanOrEqualsTo(new TestNumberObject());
    ...
    void testBuildOrGreaterOrEqualPredicate() {
        ...
        orFilter.setIsGreaterThanOrEqualsTo(new TestNumberObject());
