...
//
//        assertEquals(atStartOfDay(new Date(new Date().getTime() - (1000 * 60 * 60 * 24))), normalLowerBound
//        .getLiteral());
//        assertEquals(atEndOfDay(new Date(new Date().getTime() - (1000 * 60 * 60 * 24))), normalUpperBound
//        .getLiteral());
//
