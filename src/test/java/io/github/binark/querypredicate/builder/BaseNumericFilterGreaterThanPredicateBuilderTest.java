...
class BaseNumericFilterGreaterThanPredicateBuilderTest {
    ...
    @Test
    void buildCombinedIsNotNullAndIsGreaterThanPredicates() {
        ...
        LiteralExpression greaterThanLiteralExpression =
                (LiteralExpression) greaterThanComparisonPredicate.getRightHandOperand();
